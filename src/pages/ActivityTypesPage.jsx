...
import {
    Plus, Edit, Activity, Trash2, ChevronLeft, ChevronRight
} from 'lucide-react';
import {
    FormField, Input, Select, Button, Modal, SearchBar, Toast, PageHeader, ConfirmModal, CheckboxCard, SortableTh, PageSizeSelect
} from '../components/ui';
...
export default function ActivityTypesPage() {
    ...
    } = useClientPagination(sortedActivities);
