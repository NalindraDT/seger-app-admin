        ...
        <div className="space-y-6 relative">
            ...
            <div className="border-b border-gray-200 overflow-x-auto">
                <nav className="flex w-max min-w-full space-x-6 sm:space-x-8">
                    <button onClick={() => { setActiveTab('exp'); setSearchTerm(''); }} className={`py-3.5 px-1 font-bold text-sm border-b-2 transition-colors whitespace-nowrap ${activeTab === 'exp' ? 'border-[#5A2EFF] text-[#5A2EFF]' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'}`}>
                        Aturan EXP
                    </button>
                    <button onClick={() => { setActiveTab('point'); setSearchTerm(''); }} className={`py-3.5 px-1 font-bold text-sm border-b-2 transition-colors whitespace-nowrap ${activeTab === 'point' ? 'border-[#5A2EFF] text-[#5A2EFF]' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'}`}>
                        Aturan Poin
                    </button>
                </nav>
            </div>
